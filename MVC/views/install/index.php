...
<div id="form-install-database">
  <form action="install/database" name="install" /><br />
    ...
    <div id="form-install-database-password" class="form-input">
      <label>Password</label><input type="text" name="password" />
    </div>
    <div id="form-install-database-name" class="form-input">
      <label>Name</label><input type="text" name="name" />
    </div>
    <div id="form-install-database-name" class="form-input submit">
